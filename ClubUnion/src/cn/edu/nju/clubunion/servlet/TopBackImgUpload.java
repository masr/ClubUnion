...
public class TopBackImgUpload extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		System.out.println("top_back_img_upload_start");
		File tmpDir;
		File saveDir;
		String url = null;
		...
		if (request.getMethod().equalsIgnoreCase("post")) {
			...
			out.print("<script>window.parent.UploadResponse.LoadTopBackIMG('"
					+ url + "')</script>");
