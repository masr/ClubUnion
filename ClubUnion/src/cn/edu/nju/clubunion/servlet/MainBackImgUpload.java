...
public class MainBackImgUpload extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		System.out.println("main_back_img_upload_start");
		File tmpDir;
		File saveDir;
		String url = null;
		...
		if (request.getMethod().equalsIgnoreCase("post")) {
			...
			out
					.print("<script>window.parent.UploadResponse.LoadMainBackIMG('"
							+ url + "')</script>");
