...
public class RightBackImgUpload extends HttpServlet {

	private FileSaver saver;

	public RightBackImgUpload() {
		super();
	}
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		System.out.println("right_back_img_upload_start");
		File tmpDir;
		File saveDir;
		String url = null;
		...
		if (request.getMethod().equalsIgnoreCase("post")) {
			...
			out.print("<script>window.parent.UploadResponse.LoadRightBackIMG('"
					+ url + "')</script>");
